...
if __name__ == '__main__':
    ...
    root.title('❤')
    root.resizable(0, 0)
    # root.wm_attributes("-toolwindow", 1)  # This line has been removed
    screenwidth = root.winfo_screenwidth()
    screenheight = root.winfo_screenheight()
    widths = 300
    heights = 100
    ...
    tk.Label(root, text='Honey, would you want to be my girlfriend?', width=37, font=('宋体', 12)).place(x=0, y=10)
